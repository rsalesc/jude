...
var _q = __webpack_require__(42);

var _q2 = _interopRequireDefault(_q);

var _filtered = __webpack_require__(43);

var _filtered2 = _interopRequireDefault(_filtered);

var _addusers = __webpack_require__(44);

var _addusers2 = _interopRequireDefault(_addusers);

var _logoutHeaderButton = __webpack_require__(45);
...
myApp.config(["NgAdminConfigurationProvider", function (nga) {
  ...
  // add layout
  admin.header(__webpack_require__(88));
...
exports.addUsersTemplate = exports.addUsersController = undefined;

var _getIterator2 = __webpack_require__(84);

var _getIterator3 = _interopRequireDefault(_getIterator2);

var _papaparse = __webpack_require__(87);
...
function correctlyParse(content) {
  try {
    ...
    var parsed = _papaparse2.default.parse(content, { delimiter: ":", encoding: "utf-8", skipEmptyLines: true });
    if (!parsed.data) return { users: [] };
    ...
    try {
      for (var _iterator = (0, _getIterator3.default)(parsed.data), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var row = _step.value;
    ...
    return {
      override: true,
      users: parsed.data.map(function (x) {
        return {
          handle: x[0],
          password: x[1],
          name: x[2],
...
addUsersController.prototype.submit = function () {
  ...
  var parsed = correctlyParse(this.content);
  var len = !parsed.users ? 0 : parsed.users.length;
  this.restangular.one("contests", this.contestId).customPOST(parsed, "addUsers").then(function () {
    return _this.notification.log(len + " users were added.", { addnCls: "humane-flatty-success" });
  }).catch(function (e) {
