...
var _q = __webpack_require__(35);

var _q2 = _interopRequireDefault(_q);

var _filtered = __webpack_require__(34);

var _filtered2 = _interopRequireDefault(_filtered);

var _rejudge = __webpack_require__(33);
...
myApp.config(['NgAdminConfigurationProvider', function (nga) {
    ...
    contest.listView().fields([nga.field('_id').label("#").isDetailLink(true).editable(false), nga.field('name').validation({
        ...
        minlength: 4,
        maxlength: 64
    }), nga.field('start_time', 'datetime'), nga.field('end_time', 'datetime')]).filters([(0, _q2.default)(nga)]).listActions([(0, _filtered2.default)("submissions", "{contest: entry.values.id}", "Submissions"), (0, _filtered2.default)("users", "{contest: entry.values.id}", "Users"), 'edit', 'delete']);
    ...
    submission.showView().fields(submission.listView().fields().concat([nga.field('code', 'text'), nga.field('language')]));
